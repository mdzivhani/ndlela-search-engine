...
echo ""
echo "   a. Go to: https://github.com/mdzivhani/ndlela-search-engine/settings/secrets/actions"
...
echo ""
echo "   a. Go to: https://github.com/mdzivhani/ndlela-search-engine/settings/actions"
...
echo ""
echo "   a. Go to: https://github.com/mdzivhani/ndlela-search-engine/settings/environments"
